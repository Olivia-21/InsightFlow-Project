    ...
    public ByteArrayOutputStream generateCsv(List<Review> reviews) throws IOException {
        ...
        try (OutputStreamWriter writer = new OutputStreamWriter(out, StandardCharsets.UTF_8);
             CSVPrinter printer = new CSVPrinter(writer, CSVFormat.DEFAULT
                     .builder()
                     .setHeader("review_id", "user_id", "product_id", "product_name", "store_id", "store_name", "rating", "comment", "review_date")
                     .build())) {
            ...
            for (Review review : reviews) {
                printer.printRecord(
                        ...
                        review.getProduct() != null && review.getProduct().getStore() != null ? review.getProduct().getStore().getStoreId() : null,
                        review.getProduct() != null && review.getProduct().getStore() != null ? review.getProduct().getStore().getStoreName() : null,
                        review.getRating(),
                        review.getComment(),
